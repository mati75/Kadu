...
#define  GLOBALHOTKEYS_SHOWANDACTIVATETIMERWAITTIME                          50   /* ms */
#define  GLOBALHOTKEYS_STATUSMENUINACTIVITYTIMERINTERVAL                    100   /* ms */
#define  GLOBALHOTKEYS_CONTACTSMENUINACTIVITYTIMERINTERVAL                  100   /* ms */
#define  GLOBALHOTKEYS_CONTACTSMENUSMALLICONSIZE                             16
#define  GLOBALHOTKEYS_CONTACTSMENUICONMARGINLEFT                             6
#define  GLOBALHOTKEYS_CONTACTSMENUICONMARGINRIGHT                            3
#define  GLOBALHOTKEYS_CONTACTSMENUICONSPACING                               10
